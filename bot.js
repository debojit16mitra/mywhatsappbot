...
const {Message, StringSession, Image, Video} = require('./bunnybot');
...
setInterval(async () => { 
    ...
    var getGMTm = new Date().getMinutes()
        await axios.get('https://gist.githubusercontent.com/debojit16mitra/c4f54c0d04240f38368ce88cc9d0f81b/raw/').then(async (ann) => {
                ...
                */    // ====================================================================
                    ...
                    if (sendMsg) {
                        ...
                        try {
                            ...
                            if (config.LANG == 'SI') {
                                await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*-- දෝෂ වාර්තාව [Büññy®Bot] --*' + 
                                    '\n\n*Büññy®Bot Bot දෝෂයක් සිදුවී ඇත!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*⚜️ දෝෂ විශ්ලේෂණය [Büññy®Bot] ⚜️*' + 
                                        '\n==== ```දෝෂ නිරාකරණය කර ඇත!``` ====' +
                                ...
                                await QueenAmdiCon.sendMessage(QueenAmdiCon.user.jid, '*-- ERROR REPORT [Büññy®Bot] --*' + 
                                    '\n\n*Büññy®Bot an error has occurred!*'+
