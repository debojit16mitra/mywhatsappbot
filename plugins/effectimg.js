...
Amdi.applyCMD({pattern: 'monsoon ?(.*)', fromMe: LOL,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
if (Config.CHAT_BOT == 'true') {
  if (match[1] === '') return await message.client.sendMessage(message.jid,Lang.NEED_WORD);

  var webimage = await axios.get(`https://api.zeks.me/api/dropwater?apikey=qq8HkOVf1abvIWYqjMohCTETMrh&text=${match[1]}`, { responseType: 'arraybuffer' })
...
Amdi.applyCMD({pattern: 'flowertxt ?(.*)', fromMe: LOL,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
if (Config.CHAT_BOT == 'true') {
  if (match[1] === '') return await message.client.sendMessage(message.jid,Lang.NEED_WORD);

  var webimage = await axios.get(`https://api.zeks.me/api/flowertext?apikey=qq8HkOVf1abvIWYqjMohCTETMrh&text=${match[1]}`, { responseType: 'arraybuffer' })
...
Amdi.applyCMD({pattern: 'crosslogo ?(.*)', fromMe: LOL,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
if (Config.CHAT_BOT == 'true') {
  if (match[1] === '') return await message.client.sendMessage(message.jid,Lang.NEED_WORD);

  var webimage = await axios.get(`https://api.zeks.me/api/crosslogo?apikey=TgzSEsXLPopdlMik61BPsSCKQsh&text=${match[1]}`, { responseType: 'arraybuffer' })
...
Amdi.applyCMD({pattern: 'lovely ?(.*)', fromMe: LOL,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
if (Config.CHAT_BOT == 'true') {
  if (match[1] === '') return await message.client.sendMessage(message.jid,Lang.NEED_WORD);

  var webimage = await axios.get(`https://api.zeks.me/api/glowtext?apikey=TgzSEsXLPopdlMik61BPsSCKQsh&text=${match[1]}`, { responseType: 'arraybuffer' })
...
Amdi.applyCMD({pattern: 'skytext ?(.*)', fromMe: LOL,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
if (Config.CHAT_BOT == 'true') {
  if (match[1] === '') return await message.client.sendMessage(message.jid,Lang.NEED_WORD);

  var webimage = await axios.get(`https://api.zeks.me/api/skytext?apikey=TgzSEsXLPopdlMik61BPsSCKQsh&text=${match[1]}`, { responseType: 'arraybuffer' })
...
if (Config.CHAT_BOT == 'true') {
  ...
  var webimage = await axios.get(`https://api.zeks.me/api/lithgtext?apikey=qq8HkOVf1abvIWYqjMohCTETMrh&text=${match[1]}`, { responseType: 'arraybuffer' })
...
Amdi.applyCMD({pattern: 'christmas ?(.*)', fromMe: LOL,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
if (Config.CHAT_BOT == 'true') {
  if (match[1] === '') return await message.client.sendMessage(message.jid,Lang.NEED_WORD);

  var webimage = await axios.get(`https://api.zeks.me/api/crismes?apikey=TgzSEsXLPopdlMik61BPsSCKQsh&text=${match[1]}`, { responseType: 'arraybuffer' })
...
Amdi.applyCMD({pattern: 'snowtxt ?(.*)', fromMe: LOL,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
if (Config.CHAT_BOT == 'true') {
    if (match[1] === '') return await message.client.sendMessage(message.jid,Lang.NEED_WORD);
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.zeks.me/api/snowwrite?apikey=qq8HkOVf1abvIWYqjMohCTETMrh&text1=${topText}&text2=${bottomText}`, { responseType: 'arraybuffer' })
...
Amdi.applyCMD({pattern: 'watercolor ?(.*)', fromMe: LOL,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
if (Config.CHAT_BOT == 'true') {
    if (match[1] === '') return await message.client.sendMessage(message.jid,Lang.NEED_WORD);
  ...
  var topText, bottomText;
    ...
    var webimage = await axios.get(`https://api.zeks.me/api/watercolour?apikey=qq8HkOVf1abvIWYqjMohCTETMrh&text1=${topText}&text2=${bottomText}`, { responseType: 'arraybuffer' })
...
Amdi.applyCMD({pattern: 'zang ?(.*)', fromMe: LOL,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
if (Config.CHAT_BOT == 'true') {
  if (match[1] === '') return await message.client.sendMessage(message.jid,Lang.NEED_WORD);

  var webimage = await axios.get(`https://docs-jojo.herokuapp.com/api/meme-gen?top=%20&bottom=${match[1]}&img=https://i.imgur.com/3oiVAaC.jpeg`, { responseType: 'arraybuffer' })
