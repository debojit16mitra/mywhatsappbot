...
if (Config.WORKTYPE == 'private') {
    ...
    Amdi.applyCMD({pattern: 'carbon$', fromMe: true, desc: Lang.CARBON_DESC,  deleteCommand: false}, (async (message, match) => {
    ...
    Amdi.applyCMD({pattern: 'carbon$', fromMe: false, desc: Lang.CARBON_DESC}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(respoimage.data), MessageType.image, { mimetype: Mimetype.png, caption: copy , thumbnail: thumb })
    }));
}
