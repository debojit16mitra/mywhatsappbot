...
const bunnybunny = require('../events');
const {MessageType, MessageOptions, Mimetype} = require('@adiwajshing/baileys');
const axios = require('axios');
const Config = require('../config');
const copy = Config.CAP
...
if (Config.WORKTYPE == 'private') {
    ...
    bunny.applyCMD({pattern: 'carbon$', fromMe: true, desc: Lang.CARBON_DESC,  deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(respoimage.data), MessageType.image, { mimetype: Mimetype.png, caption: copy})

    }));
}
else if (Config.WORKTYPE == 'public') {

    bunny.applyCMD({pattern: 'carbon$', fromMe: false, desc: Lang.CARBON_DESC, dontAddCommandList: true}, (async (message, match) => {
