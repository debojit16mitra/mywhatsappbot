...
const fs = require("fs")
const amdi = fs.readFileSync('./media/bunnybot.mp4')  
let LOL = Config.WORKTYPE == 'public' ? false : true

const Language = require('../language');
const Lang = Language.getString('_amdi');
const dmenu = "💠●Büññy®Bot Help Panel●💠\n\n"
