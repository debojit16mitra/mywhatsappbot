...
bunny.addCommand({pattern: 'filter ?(.*)', fromMe: true, desc: Lang.FILTER_DESC, usage: '.filter "merhaba" "merhaba, nasılsın?"'}, (async (message, match) => {
...
bunny.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
